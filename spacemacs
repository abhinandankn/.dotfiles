...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("IBMPlexMono"
                               :size 16
                               :weight normal
                               :width normal
                               :powerline-scale 1.4)
...
you should place your code here."
  ;; org export, open zathura for open files
  (add-hook 'org-mode-hook
            '(lambda ()
               (delete '("\\.pdf\\'" . default) org-file-apps)
               (add-to-list 'org-file-apps '("\\.pdf\\'" . "zathura %s"))))

  ;; disable ~ on empty lines on default
  ...
  (setq org-publish-project-alist
        '(("org-notes"
           ...
           :publishing-directory "~/Documents/Org/html_exports/"
           :publishing-function org-twbs-publish-to-html
           :with-sub-superscript nil
           )))
  (defun org-twbs-publish-buffer ()
    (interactive)
    (save-buffer)
